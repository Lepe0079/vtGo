export namespace main {
	...
	export class CollectionAlbum {
	    ...
	    static createFrom(source: any = {}) {
	        return new CollectionAlbum(source);
	    }
	...
	export class ApiResponse___main_CollectionAlbum_ {
	    success: boolean;
	    data: CollectionAlbum[];
	    error?: string;
	
	    static createFrom(source: any = {}) {
	        return new ApiResponse___main_CollectionAlbum_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.success = source["success"];
	        this.data = this.convertValues(source["data"], CollectionAlbum);
	        this.error = source["error"];
	    }
